...
## TODO: Tooltip
@export var sun_horizon_light_color: Color = Color(.98, 0.523, 0.294, 1.0):
	set(value):
...
## TODO: Tooltip
@export var moon_light_color: Color = Color(0.572549, 0.776471, 0.956863, 1.0):
	set(value):
...
## TODO: Tooltip
@export var atm_night_tint: Color = Color(0.168627, 0.2, 0.25098, 1.0): 
	set(value):
