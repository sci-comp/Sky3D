...
func build_scene():
	...
	sky_mesh.name = SkyConst.SKY_INSTANCE
	sky_sphere = SphereMesh.new()
	sky_mesh.mesh = sky_sphere
	sky_material = ShaderMaterial.new()
	sky_material.shader = SkyConst._pv_sky_shader
	sky_material.set_shader_parameter(SkyConst.NOISE_TEX, SkyConst._stars_field_noise)
	sky_mesh.material_override = sky_material
	__setup_mesh_instance(sky_mesh, SkyConst.DEFAULT_POSITION)
	add_child(sky_mesh)
	
	# Moon Render
	moon_render = SkyConst._moon_render.instantiate()
	moon_render.name = SkyConst.MOON_INSTANCE
	...
	clouds_cumulus_mesh.name = SkyConst.CLOUDS_C_INSTANCE
	...
	clouds_cumulus_material.shader = SkyConst._clouds_cumulus_shader
	clouds_cumulus_mesh.material_override = clouds_cumulus_material
	__setup_mesh_instance(clouds_cumulus_mesh, SkyConst.DEFAULT_POSITION)
	add_child(clouds_cumulus_mesh)
	
	fog_mesh = MeshInstance3D.new()
	fog_mesh.name = SkyConst.FOG_INSTANCE
	...
	fog_material.shader = SkyConst._fog_shader
...
func update_color_correction_params() -> void:
	...
	p.x = tonemap_level
	p.y = exposure
	sky_material.set_shader_parameter(SkyConst.COLOR_CORRECTION_P, p)
	fog_material.set_shader_parameter(SkyConst.COLOR_CORRECTION_P, p)
...
func update_ground_color():
	...
	sky_material.set_shader_parameter(SkyConst.GROUND_COLOR_P, ground_color)
...
func update_horizon_level() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.HORIZON_LEVEL, horizon_level)
...
func update_atm_quality() -> void:
	...
	if atm_quality == SkyQuality.Low:
		sky_material.shader = SkyConst._sky_shader
...
func update_atm_darkness() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.ATM_DARKNESS_P, atm_darkness)
	fog_material.set_shader_parameter(SkyConst.ATM_DARKNESS_P, atm_darkness)
...
func update_atm_sun_intensity() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.ATM_SUN_INTENSITY_P, atm_sun_intensity)
	fog_material.set_shader_parameter(SkyConst.ATM_SUN_INTENSITY_P, atm_sun_intensity)
...
func update_atm_day_tint() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.ATM_DAY_TINT_P, atm_day_tint)
	fog_material.set_shader_parameter(SkyConst.ATM_DAY_TINT_P, atm_day_tint)
...
func update_atm_horizon_light_tint() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.ATM_HORIZON_LIGHT_TINT_P, atm_horizon_light_tint)
	fog_material.set_shader_parameter(SkyConst.ATM_HORIZON_LIGHT_TINT_P, atm_horizon_light_tint)
...
func update_atm_level_params():
	...
	sky_material.set_shader_parameter(SkyConst.ATM_LEVEL_PARAMS_P, atm_level_params)
	fog_material.set_shader_parameter(SkyConst.ATM_LEVEL_PARAMS_P, atm_level_params + fog_atm_level_params_offset)
...
func update_atm_thickness():
	...
	sky_material.set_shader_parameter(SkyConst.ATM_THICKNESS_P, atm_thickness)
	fog_material.set_shader_parameter(SkyConst.ATM_THICKNESS_P, atm_thickness)
...
func update_atm_sun_mie_tint() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.ATM_SUN_MIE_TINT_P, atm_sun_mie_tint)
	fog_material.set_shader_parameter(SkyConst.ATM_SUN_MIE_TINT_P, atm_sun_mie_tint)
	clouds_cumulus_material.set_shader_parameter(SkyConst.ATM_SUN_MIE_TINT_P, atm_sun_mie_tint)
...
func update_atm_sun_mie_intensity() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.ATM_SUN_MIE_INTENSITY_P, atm_sun_mie_intensity)
	fog_material.set_shader_parameter(SkyConst.ATM_SUN_MIE_INTENSITY_P, atm_sun_mie_intensity)
...
func update_atm_sun_mie_anisotropy() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.ATM_SUN_PARTIAL_MIE_PHASE_P, partial)
	fog_material.set_shader_parameter(SkyConst.ATM_SUN_PARTIAL_MIE_PHASE_P, partial)
...
func update_atm_moon_mie_tint() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.ATM_MOON_MIE_TINT_P, atm_moon_mie_tint)
	fog_material.set_shader_parameter(SkyConst.ATM_MOON_MIE_TINT_P, atm_moon_mie_tint)
	clouds_cumulus_material.set_shader_parameter(SkyConst.ATM_MOON_MIE_TINT_P, atm_moon_mie_tint)
...
func update_atm_moon_mie_intensity() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.ATM_MOON_MIE_INTENSITY_P, atm_moon_mie_intensity * atm_moon_phases_mult())
	fog_material.set_shader_parameter(SkyConst.ATM_MOON_MIE_INTENSITY_P, atm_moon_mie_intensity * atm_moon_phases_mult())
...
func update_atm_moon_mie_anisotropy() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.ATM_MOON_PARTIAL_MIE_PHASE_P, partial)
	fog_material.set_shader_parameter(SkyConst.ATM_MOON_PARTIAL_MIE_PHASE_P, partial)
...
func update_fog_density() -> void:
	...
	fog_material.set_shader_parameter(SkyConst.ATM_FOG_DENSITY_P, fog_density)
...
func update_fog_start() -> void:
	...
	fog_material.set_shader_parameter(SkyConst.ATM_FOG_START, fog_start)
...
func update_fog_end() -> void:
	...
	fog_material.set_shader_parameter(SkyConst.ATM_FOG_END, fog_end)
...
func update_fog_rayleigh_depth() -> void:
	...
	fog_material.set_shader_parameter(SkyConst.ATM_FOG_RAYLEIGH_DEPTH_P, fog_rayleigh_depth)
...
func update_fog_mie_depth() -> void:
	...
	fog_material.set_shader_parameter(SkyConst.ATM_FOG_MIE_DEPTH_P, fog_mie_depth)
...
func update_fog_falloff() -> void:
	...
	fog_material.set_shader_parameter(SkyConst.ATM_FOG_FALLOFF, fog_falloff)
...
func update_sun_disk_color() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.SUN_DISK_COLOR_P, sun_disk_color)
...
func update_sun_disk_intensity() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.SUN_DISK_INTENSITY_P, sun_disk_intensity)
...
func update_sun_disk_size() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.SUN_DISK_SIZE_P, sun_disk_size)
...
func update_moon_color() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.MOON_COLOR_P, moon_color)
...
func update_moon_size() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.MOON_SIZE_P, moon_size)
...
func set_enable_set_moon_texture(value: bool) -> void:
	...
	if not value:
		set_moon_texture(SkyConst._moon_texture)
...
func update_moon_texture() -> void:
	...
	moon_material.set_shader_parameter(SkyConst.TEXTURE_P, moon_texture)
...
func update_moon_resolution() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.MOON_TEXTURE_P, moon_render.get_texture())
...
func update_deep_space_basis() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.DEEP_SPACE_MATRIX_P, __deep_space_basis)
...
func update_background_color() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.BG_COL_P, background_color)
...
func set_set_background_texture(value: bool) -> void:
	...
	if not value:
		_set_background_texture(SkyConst._background_texture)
...
func update_background_texture() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.BG_TEXTURE_P, background_texture)
...
func update_stars_field_color() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.STARS_COLOR_P, stars_field_color)
...
func set_set_stars_field_texture(value: bool) -> void:
	...
	if not value:
		_set_stars_field_texture(SkyConst._stars_field_texture)
...
func update_stars_field_texture() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.STARS_TEXTURE_P, stars_field_texture)
...
func update_stars_scintillation() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.STARS_SC_P, stars_scintillation)
...
func update_stars_scintillation_speed() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.STARS_SC_SPEED_P, stars_scintillation_speed)
...
func update_clouds_thickness() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.CLOUDS_THICKNESS, clouds_thickness)
...
func update_clouds_coverage() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.CLOUDS_COVERAGE, clouds_coverage)
...
func update_clouds_absorption() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.CLOUDS_ABSORPTION, clouds_absorption)
...
func update_clouds_sky_tint_fade() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.CLOUDS_SKY_TINT_FADE, clouds_sky_tint_fade)
...
func update_clouds_intensity() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.CLOUDS_INTENSITY, clouds_intensity)
...
func update_clouds_size() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.CLOUDS_SIZE, clouds_size)
...
func update_clouds_uv() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.CLOUDS_UV, clouds_uv)
...
func update_clouds_offset() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.CLOUDS_OFFSET, clouds_offset)
...
func update_clouds_offset_speed() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.CLOUDS_OFFSET_SPEED, clouds_offset_speed)
...
func set_set_clouds_texture(value: bool) -> void:
	...
	if not value:
		_set_clouds_texture(SkyConst._clouds_texture)
...
func update_clouds_texture() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.CLOUDS_TEXTURE, clouds_texture)
...
func update_clouds_cumulus_day_color() -> void:
	...
	clouds_cumulus_material.set_shader_parameter(SkyConst.CLOUDS_DAY_COLOR, clouds_cumulus_day_color)
...
func update_clouds_cumulus_horizon_light_color() -> void:
	...
	clouds_cumulus_material.set_shader_parameter(SkyConst.CLOUDS_HORIZON_LIGHT_COLOR, clouds_cumulus_horizon_light_color)
...
func update_clouds_cumulus_night_color() -> void:
	...
	clouds_cumulus_material.set_shader_parameter(SkyConst.CLOUDS_NIGHT_COLOR, clouds_cumulus_night_color)
...
func update_clouds_cumulus_thickness() -> void:
	...
	clouds_cumulus_material.set_shader_parameter(SkyConst.CLOUDS_THICKNESS, clouds_cumulus_thickness)
...
func update_clouds_cumulus_coverage() -> void:
	...
	clouds_cumulus_material.set_shader_parameter(SkyConst.CLOUDS_COVERAGE, clouds_cumulus_coverage)
...
func update_clouds_cumulus_absorption() -> void:
	...
	clouds_cumulus_material.set_shader_parameter(SkyConst.CLOUDS_ABSORPTION, clouds_cumulus_absorption)
...
func update_clouds_cumulus_noise_freq() -> void:
	...
	clouds_cumulus_material.set_shader_parameter(SkyConst.CLOUDS_NOISE_FREQ, clouds_cumulus_noise_freq)
...
func update_clouds_cumulus_intensity() -> void:
	...
	clouds_cumulus_material.set_shader_parameter(SkyConst.CLOUDS_INTENSITY, clouds_cumulus_intensity)
...
func update_clouds_cumulus_mie_intensity() -> void:
	...
	clouds_cumulus_material.set_shader_parameter(SkyConst.CLOUDS_MIE_INTENSITY, clouds_cumulus_mie_intensity)
...
func update_clouds_cumulus_mie_anisotropy() -> void:
	...
	clouds_cumulus_material.set_shader_parameter(SkyConst.CLOUDS_PARTIAL_MIE_PHASE, partial)
...
func update_clouds_cumulus_size() -> void:
	...
	clouds_cumulus_material.set_shader_parameter(SkyConst.CLOUDS_SIZE, clouds_cumulus_size)
...
func update_clouds_cumulus_offset() -> void:
	...
	clouds_cumulus_material.set_shader_parameter(SkyConst.CLOUDS_OFFSET, clouds_cumulus_offset)
...
func update_clouds_cumulus_offset_speed() -> void:
	...
	clouds_cumulus_material.set_shader_parameter(SkyConst.CLOUDS_OFFSET_SPEED, clouds_cumulus_offset_speed)
...
func set_set_clouds_cumulus_texture(value: bool) -> void:
	...
	if not value:
		_set_clouds_cumulus_texture(SkyConst._clouds_cumulus_texture)
...
func update_clouds_cumulus_texture() -> void:
	...
	clouds_cumulus_material.set_shader_parameter(SkyConst.CLOUDS_TEXTURE, clouds_cumulus_texture)
...
func update_sun_coords() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.SUN_DIR_P, sun_direction())
	fog_material.set_shader_parameter(SkyConst.SUN_DIR_P, sun_direction())
	moon_material.set_shader_parameter(SkyConst.SUN_DIR_P, sun_direction())
	clouds_cumulus_material.set_shader_parameter(SkyConst.SUN_DIR_P, sun_direction())
...
func update_moon_coords() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.MOON_DIR_P, moon_direction())
	fog_material.set_shader_parameter(SkyConst.MOON_DIR_P, moon_direction())
	moon_material.set_shader_parameter(SkyConst.MOON_DIR_P, moon_direction())
	clouds_cumulus_material.set_shader_parameter(SkyConst.MOON_DIR_P, moon_direction())
	sky_material.set_shader_parameter(SkyConst.MOON_MATRIX, __moon_transform.basis.inverse())
...
func update_beta_ray() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.ATM_BETA_RAY_P, betaRay)
	fog_material.set_shader_parameter(SkyConst.ATM_BETA_RAY_P, betaRay)
...
func update_beta_mie() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.ATM_BETA_MIE_P, bm)
	fog_material.set_shader_parameter(SkyConst.ATM_BETA_MIE_P, bm)
...
func update_night_intensity() -> void:
	...
	sky_material.set_shader_parameter(SkyConst.ATM_NIGHT_TINT_P, tint)
	fog_material.set_shader_parameter(SkyConst.ATM_NIGHT_TINT_P, atm_night_tint * fog_atm_night_intensity())
...
func update_moon_light_energy() -> void:
	...
	__moon_light_node.light_energy = l * SkyConst._sun_moon_curve_fade.sample_baked(fade)
